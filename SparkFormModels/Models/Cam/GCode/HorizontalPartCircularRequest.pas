unit HorizontalPartCircularRequest;
...
type
  THorizontalPartCircularRequestDetail = class
  public
    AStream: TStream;
    AFileName: string;
  ...
  THorizontalPartCircularRequest = class
  public
    History: TList<THorizontalPartCircularRequestDetail>;
    Detail: THorizontalPartCircularRequestDetail;
...
{ THorizontalPartCircularRequest }

constructor THorizontalPartCircularRequestDetail.Create;
begin
...
destructor THorizontalPartCircularRequestDetail.Destroy;
begin
...
constructor THorizontalPartCircularRequest.Create;
begin
  Detail := THorizontalPartCircularRequestDetail.Create;
  History := TList<THorizontalPartCircularRequestDetail>.Create;
...
destructor THorizontalPartCircularRequest.Destroy;
begin
