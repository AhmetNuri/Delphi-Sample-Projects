unit HorizontalPartLinearRequest;
...
type
  THorizontalPartLinearRequestDetail = class
  public
    AStream: TStream;
    AFileName: string;
  ...
  THorizontalPartLinearRequest = class
  public
    History: TList<THorizontalPartLinearRequestDetail>;
    Detail: THorizontalPartLinearRequestDetail;
...
{ THorizontalPartLinearRequest }

constructor THorizontalPartLinearRequestDetail.Create;
begin
...
destructor THorizontalPartLinearRequestDetail.Destroy;
begin
...
constructor THorizontalPartLinearRequest.Create;
begin
  Detail := THorizontalPartLinearRequestDetail.Create;
  History := TList<THorizontalPartLinearRequestDetail>.Create;
...
destructor THorizontalPartLinearRequest.Destroy;
begin
